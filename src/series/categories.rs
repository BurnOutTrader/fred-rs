...
impl Builder {
    ...
    /// 
    /// [https://research.stlouisfed.org/docs/api/fred/series_categories.html#realtime_start](https://research.stlouisfed.org/docs/api/fred/series_categories.html#realtime_start)
